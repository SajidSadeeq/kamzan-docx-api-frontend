                ...
                <div class="card-inner">
                  <ul class="nav nav-tabs mt-n3">
                    ...
                    <li class="nav-item" @click="activeTab = 2">
                      <a class="nav-link" :class="{ active: activeTab === 2 }" data-toggle="tab" href="#details"><em class="icon ni ni-link" /><span>Details</span></a>
                    </li>
                    <li class="nav-item" @click="activeTab = 3">
                      <a class="nav-link" :class="{ active: activeTab === 3 }" data-toggle="tab" href="#meta"><em class="icon ni ni-link" /><span>Meta</span></a>
                    </li>
                  </ul>
                  <div class="tab-content">
                    ...
                    <div id="tabItem6" class="tab-pane" :class="{ active: activeTab === 3 }">
                      <p>Third Culpa dolor voluptate do laboris laboris irure reprehenderit id incididunt duis pariatur mollit aute magna pariatur consectetur. Eu veniam duis non ut dolor deserunt commodo et minim in quis laboris ipsum velit id veniam. Quis ut consectetur adipisicing officia excepteur non sit. Ut et elit aliquip labore Lorem enim eu. Ullamco mollit occaecat dolore ipsum id officia mollit qui esse anim eiusmod do sint minim consectetur qui.</p>
                    </div>
                  </div>
                </div>
              </div><!-- .card-preview -->
