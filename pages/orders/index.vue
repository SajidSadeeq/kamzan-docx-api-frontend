                    ...
                    <ul class="nk-block-tools g-3">
                      <li>
                        <div class="form-control-wrap">
                          ...
                          <input id="default-04" type="text" class="form-control" placeholder="Quick search by id">
                        </div>
                      </li>
                      <li>
                        <div class="drodown">
                      ...
                      <li class="nk-block-tools-opt">
                        ...
                        <a href="#" class="btn btn-primary d-none d-md-inline-flex"><em class="icon ni ni-plus" /><span>Add Order</span></a>
                      </li>
                    </ul>
                  </div>
                </div>
          ...
          <div class="nk-block">
            <div class="nk-tb-list is-separate is-medium mb-3">
                  ...
                  <ul class="nk-tb-actions gx-1 my-n1">
                    <li>
                      <div class="drodown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                          <ul class="link-list-opt no-bdr">
                            <li><a href="#"><em class="icon ni ni-edit" /><span>Update Status</span></a></li>
                            <li><a href="#"><em class="icon ni ni-truck" /><span>Mark as Delivered</span></a></li>
                            <li><a href="#"><em class="icon ni ni-money" /><span>Mark as Paid</span></a></li>
                            <li><a href="#"><em class="icon ni ni-report-profit" /><span>Send Invoice</span></a></li>
                            <li><a href="#"><em class="icon ni ni-trash" /><span>Remove Orders</span></a></li>
                          </ul>
                        </div>
                      </div>
                    </li>
              ...
              <div class="nk-tb-item">
                ...
                <div class="nk-tb-col">
                  <span class="dot bg-warning d-mb-none" />
                ...
                <div class="nk-tb-col nk-tb-col-tools">
                  <ul class="nk-tb-actions gx-1">
                    <li class="nk-tb-action-hidden">
                      <a href="#" class="btn btn-icon btn-trigger btn-tooltip" title="" data-toggle="dropdown" data-original-title="Mark as Delivered">
                        <em class="icon ni ni-truck" /></a>
                    </li>
                    <li class="nk-tb-action-hidden">
                      <a href="#" class="btn btn-icon btn-trigger btn-tooltip" title="" data-toggle="dropdown" data-original-title="View Order">
                        <em class="icon ni ni-eye" /></a>
                    </li>
                    <li>
                      <div class="drodown mr-n1">
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                          <ul class="link-list-opt no-bdr">
                            <li><a href="#"><em class="icon ni ni-eye" /><span>Order Details</span></a></li>
                            <li><a href="#"><em class="icon ni ni-truck" /><span>Mark as Delivered</span></a></li>
                            <li><a href="#"><em class="icon ni ni-money" /><span>Mark as Paid</span></a></li>
                            <li><a href="#"><em class="icon ni ni-report-profit" /><span>Send Invoice</span></a></li>
                            <li><a href="#"><em class="icon ni ni-trash" /><span>Remove Order</span></a></li>
                          </ul>
                        </div>
                      </div>
                    </li>
              ...
              <div class="nk-tb-item">
                ...
                <div class="nk-tb-col">
                  <span class="dot bg-success d-mb-none" />
                    ...
                    <div class="pagination-goto d-flex justify-content-center justify-content-md-start gx-3">
                      ...
                      <div>
                        ...
                        >
                          ...
                          tabindex="0"
                          aria-disabled="false"
                          aria-labelledby="select2-kdol-container"
                        ><span id="select2-kdol-container" class="select2-selection__rendered" role="textbox" aria-readonly="true" title="1">1</span><span class="select2-selection__arrow" role="presentation"><b role="presentation" /></span></span></span><span class="dropdown-wrapper" aria-hidden="true" /></span>
                      </div>
                      <div>OF 102</div>
                    </div>
                  </div><!-- .pagination-goto -->
