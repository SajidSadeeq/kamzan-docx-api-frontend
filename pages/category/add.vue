                ...
                <div class="card-inner">
                  <ul class="nav nav-tabs mt-n3">
                    <li class="nav-item" @click="activeTab = 1">
                      <a class="nav-link" :class="{ active: activeTab === 1 }" data-toggle="tab" href="#basic"><em class="icon ni ni-setting" /><span>Baisc Info</span></a>
                    </li>
...
export default {
  ...
  methods: {
    addCategory () {
      this.$axios.get(process.env.APP_URL + 'testing', {
        name: this.name,
