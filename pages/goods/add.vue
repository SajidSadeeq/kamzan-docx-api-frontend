          ...
          <form action="#" class="form-validate" novalidate="novalidate" @submit.prevent="addGood">
            <div class="nk-block nk-block-lg">
              ...
              <div class="mt-2 text-right">
                <div class="form-group">
                  <NuxtLink to="/goods" class="btn btn-danger d-md-inline-flex mr-1">
                    <em class="icon ni ni-back-ios" /><span>Back</span>
                  </NuxtLink>
                  <button type="submit" class="btn btn-primary mr-1" @submit.prevent="addGood">
                    Save
                  </button>
                  <a href="javascript:;" class="btn btn-primary d-md-inline-flex" @click="addProductArray">
